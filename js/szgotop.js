...
var Paul_Pio = function (prop) {
    ...
    var action = {
        ...
        buttons: function () {
            ...
            elements.skin.onclick = function () {
               modules.render(prop.content.night || "等一下，很快就好！！！");
                ...
                elements.night.onclick = function () {
                      if (prop.night) {
                                            ...
                                            if (prop.night) {
                                                ...
                                                document.body.style.color = "#0F0"; // 设置文字颜色为浅色
                                            } else {

                                                document.body.style.color = ""; // 恢复默认文字颜色
                                            }
                                        }


                    modules.render(prop.content.night || "你头上怎么绿油油的？");
                };
                elements.night.onmouseover = function () {
                    modules.render("举头望明月，低头思故乡~");
                };
    ...
    this.initHidden = function () {
        current.body.classList.add("l2dhidden");
        dialog.classList.remove("active");

        elements.show.onclick = function () {
            current.body.classList.remove("l2dhidden");
